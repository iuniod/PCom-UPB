...
struct client_subscription {
  ...
  bool get_connection_status() { return this->is_connected; }

  void set_connection_status(bool status) { this->is_connected = status; }

  std::vector<topic> get_topics() { return this->topics; }

  void add_notification(notification notif) { this->notifications.push(notif); }

  void add_topic(topic topic) { this->topics.push_back(topic); }
  ...
  std::queue<notification> get_notifications() { return this->notifications; }
};
